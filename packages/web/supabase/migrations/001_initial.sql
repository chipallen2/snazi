...
-- locally on the user's Mac via the wrapper CLI and never touches this database.
--
-- All tables prefixed `sna_` to avoid collisions if this runs in a shared
...
VALUES ('imessage', 'iMessage', 'Apple iMessage on the user''s Mac')
